<script lang="ts">
    ...
    <div class="viewport">
        ...
        <br>
        <p class="codepen" data-height="500" data-default-tab="result" data-slug-hash="adLPwv" data-preview="true" data-user="enxaneta" style="height: 300px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;">
